function varargout = ShowAccelerometerData(varargin)
% SHOWACCELEROMETERDATA MATLAB code for ShowAccelerometerData.fig
%      SHOWACCELEROMETERDATA, by itself, creates a new SHOWACCELEROMETERDATA or raises the existing
%      singleton*.
%
%      H = SHOWACCELEROMETERDATA returns the handle to a new SHOWACCELEROMETERDATA or the handle to
%      the existing singleton*.
%
%      SHOWACCELEROMETERDATA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SHOWACCELEROMETERDATA.M with the given input arguments.
%
%      SHOWACCELEROMETERDATA('Property','Value',...) creates a new SHOWACCELEROMETERDATA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ShowAccelerometerData_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ShowAccelerometerData_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ShowAccelerometerData

% Last Modified by GUIDE v2.5 20-Aug-2018 13:39:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ShowAccelerometerData_OpeningFcn, ...
                   'gui_OutputFcn',  @ShowAccelerometerData_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ShowAccelerometerData is made visible.
function ShowAccelerometerData_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ShowAccelerometerData (see VARARGIN)

% Choose default command line output for ShowAccelerometerData
...
handles.PlotGraphPopUpMenu.String = {'XY', 'XZ', 'YZ', 'Time', '3D'};
...
% UIWAIT makes ShowAccelerometerData wait for user response (see UIRESUME)
% uiwait(handles.ShowAccelerometerData);


% --- Outputs from this function are returned to the command line.
function varargout = ShowAccelerometerData_OutputFcn(hObject, eventdata, handles) 
...
RawData = handles.MainData.DataSet.RAW_SENSOR_DATA(4:6,:);
FilData = handles.MainData.DataSet.FILTERED_SENSOR_DATA(4:6,:);
CorData = W*(RawData-V);
PlotData = [RawData; FilData; CorData];

cla(handles.AccelerometerAxes, 'reset')
...
switch handles.RequestData
    case 'Time'
        ...
        LegendStr = {'Raw A_x', 'Raw A_y', 'Raw A_z', 'Raw A_m', 'Fil A_x', 'Fil A_y', 'Fil A_z', 'Fil A_m', 'Cor A_x', 'Cor A_y', 'Cor A_z', 'Cor A_m'};
        if(any(LegendBool))
...
% --- Executes when ShowAccelerometerData is resized.
function ShowAccelerometerData_SizeChangedFcn(hObject, eventdata, handles)
% hObject    handle to ShowAccelerometerData (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.AccelerometerAxes.Units = 'normalized';
handles.PlotGraphBtnGroup.Units = 'normalized';
handles.PlotDataType.Units = 'normalized';

% OuterPosition = [X Y Width Height]
handles.AccelerometerAxes.OuterPosition = [0 0 0.8 1];
