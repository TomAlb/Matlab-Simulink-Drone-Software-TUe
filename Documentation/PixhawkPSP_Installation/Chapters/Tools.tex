...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Tools}
\section{NSH terminal}
\section{External mode}
\url{https://nl.mathworks.com/matlabcentral/answers/126713-error-while-running-simulink-model-connecting-to-raspberry-pi-with-a-webcam-for-real-time-image-pro#answer_205985}
\section{UORB message bus}
\section{Putty}
\section{Mavlink messaging}